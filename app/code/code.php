    ...
    <div class="mainBox">
        <div class="leftBox">
            ...
            <div>
                ...
                <input style="display:none;" id="loop" type="checkbox" /> <!--暂时没用 但又不敢删-->
            </div>
...
<div>
    ...
    <div class="replyUnity">
        <div class="replyUser">
            <a href=""> 小A</a><br>
            <span class="replyTime">2019-5-21 8:34</span>
        </div>
    ...
    <div class="replyUnity">
        <div class="replyUser">
            <a href=""> 小A</a> <br>
            <span class="replyTime">2019-5-21 8:36</span>
        </div>
        <div class="replyContent">
            说句话啊
        </div>
